<template>
  ...
  >
    ...
    <a-menu theme="light" mode="inline" :selectedKeys="selectedMenuKeys">
      <a-menu-item>
      ...
      <a-menu-item>
        <router-link to="/wear">
          ...
          <span class="label">虚拟试穿</span>
        </router-link>
      </a-menu-item>
      <a-menu-item class="menu-item-header"> 个人信息 </a-menu-item>
      <a-menu-item>
    ...
    <!-- Sidebar Footer -->
    <div class="aside-footer" style="margin-top: 2px;padding-top: 20px;">
      <div class="footer-box">
        ...
        <p>or email 2826345942@qq.com</p>
        <a-button type="primary" href="/document" block target="_blank">
          DOCUMENTATION
        </a-button>
      </div>
    </div>
...
export default {
  ...
  selectedMenuKeys() {
    ...
    console.log('Current path:', path); // 检查路径是否正确
    console.log('Contains history?', path.includes('history')); // 检查是否检测到history
    return path.includes('history') ? ['history'] : [];
  }
}
};
</script>
